...
const albums: Album[] = [
  ...
  { artist: "Lisa Gerrard", name: "Duality" },
  ...
  { artist: "John Fahey", name: "Requia and Other Compositions" },
  ...
  { artist: "The Band", name: "Stage Fright (Remix 2020)" },
  ...
  { artist: "Domenique Dumont", name: "Miniatures De Auto Rhythm" },
  { artist: "The Roches", name: "The Roches" },
  { artist: "Jessy Lanza", name: "All the Time" },
  { artist: "Gal Costa", name: "Domingo" },
  { artist: "William Onyeabor", name: "Who Is William Onyeabor?" },
  {
    artist: "The Flying Burrito Brothers",
    name: "The Gilded Palace Of Sin",
  },
  { artist: "Marc Johnson's Bass Desires", name: "Second Sight" },
  { artist: "Julius Hemphill", name: "Chile New York" },
  { artist: "Lila Downs", name: "Pecados Y Milagros" },
  { artist: "Alejandra Robles", name: "La Sirena" },
  { artist: "Andrea Marchesino", name: "Altro non c'è" },
  { artist: "Tlen Huicani", name: "Veracruz Son Y Huapango" },
  { artist: "Grupo Mono Blanco Y Stone Lips", name: "El Mundo Se Va A Acabar" },
  { artist: "Clarence Carter", name: "This Is Clarence Carter" },
  { artist: "Level 42", name: "Running In The Family" },
  { artist: "Tierra Whack", name: "Whack World" },
  { artist: "Kraftwerk", name: "Autobahn" },
  { artist: "DJ Shadow", name: "Endtroducing....." },
  { artist: "Akademie für Alte Musik Berlin", name: "Handel: Water Music" },
  { artist: "Spoon", name: "Ga Ga Ga Ga Ga" },
  { artist: "Dirty Three", name: "Whatever You Love, You Are" },
  { artist: "L'Rain", name: "Fatigue" },
  { artist: "Mega Bog", name: "Life, and Another" },
  { artist: "Burning Spear", name: "Marcus Garvey" },
  { artist: "Morton Feldman", name: "Triadic Memories" },
  { artist: "Faye Webster", name: "I Know I'm Funny haha" },
  { artist: "Let's Eat Grandma", name: "I'm All Ears" },
  { artist: "Ambitious Lovers", name: "Envy" },
  { artist: "Arto Lindsay", name: "Cuidado Madame" },
  { artist: "Vince Dolphin", name: "Forever Blue" },
  { artist: "Maria Callas", name: "The Very Best of Maria Callas" },
  { artist: "SAULT", name: "Untitled (Rise)" },
  { artist: "FKA Twigs", name: "LP1" },
  {
  ...
  { artist: "Itzhak Perlman", name: "Bach - Solo Violin Sonatas" },
  { artist: "Takács Quartet", name: "Haydn: Six String Quartets" },
  { artist: "Franz Schubert", name: "Moments Musicaux" },
  { artist: "Leoš Janáček", name: "Chamber Works" },
  { artist: "They Might Be Giants", name: "Venue Songs" },
  { artist: "Dawn Richard", name: "Redemption" },
  { artist: "Animal Collective", name: "Sung Tongs" },
  {
    artist: "Elis Regina and Antônio Carlos Jobim",
    name: "Elis & Tom",
  },
  { artist: "Rosa Passos", name: "Amorosa" },
  { artist: "João Gilberto", name: "Amoroso" },
  { artist: "Paul Desmond", name: "Bossa Antigua" },
  { artist: "Noel Rosa", name: "Noel Rosa e a Sua Turma da Vila" },
  { artist: "Stan Getz", name: "Best of Two Worlds" },
  { artist: "Bebel Gilberto", name: "Tanto Tempo" },
  { artist: "Chico Buarque", name: "Os Primeiros Clássicos" },
  { artist: "Elis Regina", name: "The Essential" },
  { artist: "Moreno Veloso", name: "Coisa Boa" },
  { artist: "Novos Baianos", name: "Acabou Chorare" },
  { artist: "Carmen Miranda", name: "Lo Mejor De Carmen Miranda" },
  { artist: "Mallu Magalhães", name: "Pitanga" },
  { artist: "Os Mutantes", name: "A Divina Comédia ou Ando Meio Desligado" },
  { artist: "Tom Zé", name: "Todos os olhos" },
  { artist: "Caetano Veloso", name: "Transa" },
  { artist: "Rita Lee", name: "Hoje É O Primeiro Dia Do Resto Da Sua Vida" },
  { artist: "Cartola", name: "Raizes Do Samba" },
  { artist: "Daúde", name: "Neguinh a Te Amo" },
  { artist: "Glass Candy", name: "B/E/A/T/B/O/X" },
  { artist: "Fad Gadget", name: "Fireside Favourites" },
  { artist: "Black Marble", name: "A Different Arrangement" },
  { artist: "MGMT", name: "Little Dark Age" },
  { artist: "Slowdive", name: "Souvlaki" },
  { artist: "M83", name: "Saturdays = Youth" },
  { artist: "Wild Nothing", name: "Empty Estate" },
  {
    artist: "John Maus",
    name: "We Must Become the Pitiless Censors of Ourselves",
  },
  { artist: "Viagra Boys", name: "Street Worms" },
  { artist: "Broadcast", name: "Haha Sound" },
  { artist: "Grails", name: "Chalice Hymnal" },
  { artist: "Not Waving", name: "Animals" },
  { artist: "Mary Lattimore", name: "Silver Ladders" },
  { artist: "Arushi Jain", name: "Under the Lilac Sky" },
  { artist: "Yu Su", name: "Yellow River Blue" },
  { artist: "Boards of Canada", name: "Music Has the Right to Children" },
  { artist: "LUMP", name: "Animal" },
  { artist: "Nao", name: "Saturn" },
  { artist: "Beth Orton", name: "Kidsticks" },
  { artist: "Angel Olsen", name: "My Woman" },
  { artist: "Durand Jones & the Indications", name: "Private Space" },
  { artist: "Natalie Prass", name: "Natalie Prass" },
  { artist: "Gary Wilson", name: "You Think you Really Know Me" },
  { artist: "The Ladybug Transistor", name: "The Albemarle Sound" },
  { artist: "Life Without Buildings", name: "Any Other City" },
  { artist: "Wau Wau Collectif", name: "Yaral Sa Doom" },
  { artist: "American Music Club", name: "Mercury" },
  { artist: "Perfume Genius", name: "Too Bright" },
  { artist: "Snoh Aalegra", name: "-Ugh, those feels again" },
  { artist: "keiyaA", name: "Forever, Ya Girl" },
  { artist: "Beyoncé", name: "Lemondae" },
  { artist: "Mavis Staples", name: "You Are Not Alone" },
  { artist: "Grimes", name: "Art Angels" },
  { artist: "Banks", name: "III" },
  { artist: "Alicia Keys", name: "The Diary of Alicia Keys" },
  { artist: "Tinashe", name: "333" },
  { artist: "Kid Koala", name: "Music to Draw To" },
  { artist: "Sade", name: "Diamond Life" },
  { artist: "Niia", name: "I" },
  { artist: "Toni Braxton", name: "Toni Braxton" },
  { artist: "Lykke Li", name: "Wounded Rhymes" },
  { artist: "MØ", name: "No Mythologies to Follow" },
  { artist: "AlunaGeorge", name: "Body Music" },
  { artist: "Jessie Ware", name: "What's Your Pleasure?" },
  { artist: "Laura Mvula", name: "The Dreaming Room" },
  { artist: "Anika", name: "Anika" },
  { artist: "Rihianna", name: "ANTI" },
  { artist: "Baby Charles", name: "Baby Charles" },
  { artist: "Gwen Guthrie", name: "Gwen Guthrie" },
  { artist: "Sudan Archives", name: "Athena" },
  { artist: "Dan Deacon", name: "Glass Riffer" },
  { artist: "Red Garland", name: "Red Garland's Piano" },
  { artist: "Sean Nicholas Savage", name: "Trippple Midnight" },
  { artist: "Anna Domino", name: "Anna Domino" },
  { artist: "Saravah Soul", name: "Cultura Impura" },
  { artist: "", name: "Nigeria 70 - Funky Lagos" },
  { artist: "Coleman Hawkins", name: "Coleman Hawkins Encounters Ben Webster" },
  {
    artist: "Art Blakey & The Jazz Messengers",
    name: "Art Blakey & The Jazz Messengers",
  },
  { artist: "Gerry Mulligan", name: "The Original Quartet With Chet Baker" },
  { artist: "Charles Mingus", name: "Mingus at the Bohemia" },
  { artist: "Freddie Hubbard", name: "Open Sesame" },
